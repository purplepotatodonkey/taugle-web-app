        ...
        {/* <!-- Mission Section --> */}
            ...
            {/* <!-- Text Section --> */}
                <div>
                    ...
                    <span className="text-darkBrown font-bold text-7xl mt-2 leading-tight">Through Digital <br/> Convenience</span>
                    </h1>
                </div>
        
                {/* <!-- Image Section --> */}
                <div>
                    <img src="/src/assets/missionImage.png" alt="Group of Friends" className="rounded-bl-xl shadow-xl w-full h-auto object-cover" />
                </div>
            </div>
      
            <blockquote className="mt-8 text-center max-w-5xl mx-auto text-lightBrown font-bold text-3xl italic pt-10">
            “Connecting the world, one conversation at a time—sparking curiosity, building bridges, and empowering authentic connections.”
            </blockquote>
            ...
            <div className="mt-4 pt-5 pb-3">
                <svg className="w-6 h-6 text-darkBrown animate-bounce" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">

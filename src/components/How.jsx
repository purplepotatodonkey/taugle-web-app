...
const How = () => {
    return (
        <div className="bg-lightBrown min-h-screen flex flex-col items-center p-0 pt-0">
            {/* <!-- Title Section --> */}
            <h1 className="text-4xl lg:text-6xl font-semibold text-peachOrange mb-12 text-center pt-0">
                Welcome To Taugle
            </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-20 mb-12 max-w-6xl w-full">
                ...
                <div className="bg-peachOrange rounded-xl p-6 text-center shadow-lg">
                    ...
                    <p className="text-darkBrown text-2xl font-semibold">
                        Taugle Conversations <br/> start with a 10 second <br/> audio portion, followed <br/> by video activation<br/><br/>
                ...
                <div className="bg-peachOrange rounded-xl p-6 text-center shadow-lg">
                    ...
                    <hr className="border-t border-darkBrown my-4"/>
                    <p className="text-darkBrown text-2xl font-semibold">
                        To skip to the next chat, <br/> you have to rate your <br/> experience with our <br/> smiley rating<br/><br/>
                        <strong>Why?</strong><br/><br/>
                ...
                <div className="bg-peachOrange rounded-xl p-6 text-center shadow-lg">
                    ...
                    <hr className="border-t border-darkBrown my-4"/>
                    <p className="text-darkBrown text-2xl font-semibold">
                        The higher your vector <br/> rating, the better <br/> people you interact <br/> with<br/><br/>
                        <strong>Why?</strong><br/><br/>
